...
DATABASES = {
    'default': {
        ...
        'NAME': 'da1fd9utnhdmo9',                      # Or path to database file if using sqlite3.
        # The following settings are not used with sqlite3:
        'USER': 'fansjururqaaml',
        'PASSWORD': 'NmlDaCQx1qi7zmhTdL0LyiACrp',
        'HOST': 'ec2-54-243-44-191.compute-1.amazonaws.com',                      # Empty for localhost through domain sockets or '127.0.0.1' for localhost through TCP.
...
SECRET_KEY = 'k7&_bq^_!3h66n-yaqh(in_67z*4fz4@rsxki2idk7fq5@q*(#'
